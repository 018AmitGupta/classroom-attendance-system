...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System" ,bg="red"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
copyWrite.insert("insert", "Developed by Amit Gupta", "superscript")
